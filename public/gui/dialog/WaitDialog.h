...
public:
    explicit WaitDialog(Session* session = nullptr,QWebSocket* client = nullptr,const QString &info=QString(),const QString& title=QString(),quint8 sTimeout = 30,QWidget *parent = nullptr);
    ~WaitDialog();
